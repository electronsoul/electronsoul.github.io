  ...
  return (
    <div className="max-4xl mx-auto py-10 c-space">
      ...
      <div>
        ...
        <img
          src="/assets/blog/bloglist.jpg"
          alt="Embedded hardware blog illustration"
          className="w-full h-75 rounded object-cover shadow-lg transition-transform 
      ...
      <div className="grid md:grid-cols-2 gap-8">
        {blogs.map((post) => (
          <div 
            key={post.slug} 
            className="bg-neutral-800 rounded-lg p-6 shadow hover:shadow-xl transition">
            <img 
              src={post.image} 
              alt={post.title} 
