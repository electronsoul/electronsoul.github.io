  ...
  return (
    ...
    >
      <div className="flex flex-row items-center gap-2">
        <img className="rounded-full bg-lime-200" width="32" height="32" alt="" src={img} />
...
export default function Testimonial() {
  return (
    <div>
      <div className="c-space items-start mt-25">
        <h2 className="text-heading"> Hear From Them </h2>
      </div>
      
      <div className="relative flex w-full flex-col 
      items-center justify-center overflow-hidden mt-12">
