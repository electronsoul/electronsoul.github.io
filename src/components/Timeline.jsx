        ...
        {data.map((item, index) => (
            <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
                ...
                <div
                    ...
                    rounded-full -left-[15px] bg-midnight">
                    <div
                        className="h-4 w-4 rounded-full bg-neutral-800 border
                        border-neutral-700 p-2" />
                </div>

                <div className="hidden md:flex md:flex-col gap-2 text-xl font-bold
                 md:pl-20 md:text-4xl text-neutral-100">
                    <h3> {item.date} </h3>
        ...
        <div
          ...
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t
             from-purple-500 to-transparent from-[0%] via-[10%]
             via-lavender/50 rounded-full" />
        </div>
      </div>
    </div>
  );
